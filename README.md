...
-->
Building for this for Cloudera CDH 5.9.0 Hive specifically. Sample syntax: "mvn clean install -DskipTests -Pcloudera -Dhive.version=1.1.0-cdh5.9.0 -Dhadoop.version=2.6.0-cdh5.9.0"
